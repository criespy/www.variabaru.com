...
<tr>
            ...
            <td height="9" background="images/box_021.png" class="body9"><div align="left" style="margin: 5px 5px 3px;" class="shadow">HOT ITEMS</div>
              </td>
...
<?php
$sql=mysql_query("select * from tbltodayitem where type = 0 order by id desc");
$z=0;
...
?>
                                ...
                                <tr>
                                  <td width="250" valign="top"><table width="97%" height="200px" border="0" cellspacing="1" cellpadding="1">
                                      <tr>
                                        <td bgcolor="#CCCCCC"><table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              <td align="center" valign="middle" bgcolor="#FFFFFF"><img src="images/otherprod/<?=$field["img"]?>" width="185" height="113"></td>
                                            </tr>
                                        </table></td>
                                      </tr>
                                  </table></td>
                                            ...
                                            <tr>
                                              ...
                                              <td valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0">
                                                  <tr>
																										...
																										<input type="hidden" name="tipe" value="hotitem"/>
