...
// Support posting
function supportRequest(doForm)  
{  
	if(document.forms.postmodify.smfversion.value != 0){		
		document.forms.postmodify.message.value = '[b]SMF Version:[/b] ' +  
		document.forms.postmodify.smfversion.value +  
			'\n' +  
		document.forms.postmodify.message.value;   
	}
	return submitThisOnce(doForm);  
}
